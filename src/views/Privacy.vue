<template>
  <div class="privacy">
        ...
        <p>Nous utilisons vos identifiants &eacute;lectroniques pour rechercher des relations pr&eacute;sentes par connexion, par adresse mail ou par services. Nous pouvons utiliser vos informations de contact pour permettre &agrave; d&#39;autres personnes de trouver votre compte, notamment via des services tiers et des applications clientes. Vous pouvez t&eacute;l&eacute;charger votre carnet d&#39;adresses afin que nous soyons en mesure de vous aider &agrave; trouver des connaissances sur notre r&eacute;seau ou pour permettre &agrave; d&#39;autres Utilisateurs de notre r&eacute;seau de vous trouver. Nous pouvons vous proposer des suggestions, &agrave; vous et &agrave; d&#39;autres Utilisateurs du r&eacute;seau, &agrave; partir des contacts import&eacute;s de votre carnet d&rsquo;adresses. Nous sommes susceptibles de travailler en partenariat avec des soci&eacute;t&eacute;s qui proposent des offres incitatives. Pour prendre en charge ce type de promotion et d&#39;offre incitative, nous sommes susceptibles de partager votre identifiant &eacute;lectronique.</p>
        ...
        <p>Portabilit&eacute; des donn&eacute;es</p>
